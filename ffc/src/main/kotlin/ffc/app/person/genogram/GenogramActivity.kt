...
class GenogramActivity : FamilyFolderActivity() {
    ...
    fun loadData()
    {
        ...
        families.family {
            onSuccess {
                loadGenogram(personId, it.toJson(),org!!,it.bloodFamily!!.size);
            }
            onFail {
    ...
    fun loadGenogram(personId:String, jsonData: String, org: Organization, size:Int){
...
//                    }
        ...
        myWebView.setWebViewClient(object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView, url: String) {
                    ...
                    var scale = 0
                    var size = 0.0
                    val objJSON = JSONObject(jsonData)

...
class GeoMapsFragment : PointMarloFragment() {
    ...
    private fun setValueSwitch0()
    {
        swDisease0.isChecked =  disease1 && disease2 && disease3 && disease4 && disease5 && disease6 && disease7
        disease0 = swDisease0.isChecked
        setSwitch0Event(swDisease0,swDisease1,swDisease2,swDisease3,swDisease4,swDisease5,swDisease6,swDisease7)
    }
